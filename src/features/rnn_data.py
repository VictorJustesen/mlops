            ...
            if mapping is None:
                ...
                for col in df.columns:
                    ...
                    if 'date' in cl:
                        ...
                        if (
                            'system' in cl or 'grid' in cl or 'ampirion' in cl
                        ):
                            mapping['load'] = col
                        else:
                            mapping['production'] = col
                    elif (
                        'generation' in cl or 'production' in cl or 'wind' in cl or 'pv' in cl
                    ):
                        mapping['production'] = col
                # Fallbacks
                ...
                mapping.setdefault(
                    'production',
                    df.columns[3] if len(df.columns) > 3 else df.columns[2]
                )
